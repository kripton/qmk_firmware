...
// For macros on regular number keys 1,2,3,4,5,6,7,8,9,0
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_104_ansi(
        ...
        _______,  QM_MA01,  QM_MA02,  QM_MA03,  QM_MA04,  QM_MA05,  QM_MA06,  QM_MA07,  QM_MA08,  QM_MA09,  QM_MA10,  _______,  _______,    _______,  _______,  _______,  _______,  KC_CALC,  _______,  _______,  QK_BOOT,
        _______,  KC_BTN1,  KC_MS_U,  KC_BTN2,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
